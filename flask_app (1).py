...
import requests
sys.path.append('home/PatrickL/mysite')
...
try:
    ...
    print("second mytester")
    import PatrickL.mysite.mytester as extrahelpers
...
print("printing the enviroment variables")
			...
			try:
				...
				try:
					...
					try:
						...
						print("none dir os found")
						dir_list = os.listdir(str(cwd) + "/mysite/static/data/")

	for i in range(40):
		file = open(str(cwd) + "/mysite/static/data/" + random.choice(dir_list),"r")
